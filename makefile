...
chessprog: xml_parser.o console.o minimax.o gui.o main.o
	gcc  -o chessprog xml_parser.o console.o minimax.o gui.o main.o -lm -std=c99 -pedantic-errors -g `sdl-config --libs`

main.o: xml_parser.c console.c minimax.c gui.c main.c 
